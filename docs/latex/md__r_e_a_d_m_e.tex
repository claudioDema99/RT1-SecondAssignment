Demaria Claudio (S5433737)\hypertarget{md__r_e_a_d_m_e_autotoc_md1}{}\doxysection{Description}\label{md__r_e_a_d_m_e_autotoc_md1}
...
In order to control the robot inside the simulation, we were asked to implement three nodes. ~\newline
 ...
 The {\bfseries{third node}} should print the distance of the robot from the desired position and its average speed.\hypertarget{md__r_e_a_d_m_e_autotoc_md2}{}\doxysection{Logic of the program}\label{md__r_e_a_d_m_e_autotoc_md2}
...
$<$figure$>$  $<$/figure$>$ ~\newline
\hypertarget{md__r_e_a_d_m_e_autotoc_md3}{}\doxysection{My added nodes}\label{md__r_e_a_d_m_e_autotoc_md3}
...
{\bfseries{Flowchart of the \textquotesingle{}client\+\_\+publisher.\+py\textquotesingle{} node}} $<$figure$>$  $<$/figure$>$\hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysection{My custom message and service}\label{md__r_e_a_d_m_e_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md5}{}\doxysection{Install and run}\label{md__r_e_a_d_m_e_autotoc_md5}
...
\end{DoxyVerb}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md6}{}\doxysection{Possible improvements}\label{md__r_e_a_d_m_e_autotoc_md6}
